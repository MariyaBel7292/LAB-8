#press UP,DOWN,LEFT,RIGHT for change the way that zmeika walk(or run??)
#when you loose, the programm will automatically closed(or while you play can close on your own)
